...
library_t LIBRARIES[] = {
    { "rts430x_lc_rd_eabi_se_eh.lib", { "SMALL_ENUM","EXCEPTIONS","EABI_TDEH","RESTRICTED_DATA","MSPX" } },
    { "rts430x_lc_ld_eabi_se_eh.lib", { "MSPX","EABI_TDEH","LARGE_DATA","EXCEPTIONS","SMALL_ENUM" } },
    { "rts430_eabi_eh.lib", { "EXCEPTIONS","EABI_TDEH" } },
    { "rts430x_lc_sd_eabi_se_eh.lib", { "EABI_TDEH","MSPX","SMALL_ENUM","EXCEPTIONS" } },
    { "rts430x_lc_sd_eabi_eh.lib", { "MSPX","EABI_TDEH","EXCEPTIONS" } },
    { "rts430x_lc_sd_eabi.lib", { "MSPX" } },
    { "rts430x_lc_ld_eabi_eh.lib", { "MSPX","LARGE_DATA","EABI_TDEH","EXCEPTIONS" } },
    { "rts430x_sc_sd_eabi.lib", { "MSPX","SMALL_DATA","SMALL_CODE" } },
    { "rts430x_lc_ld_eabi.lib", { "LARGE_DATA","MSPX" } },
    { "rts430x_lc_ld_eabi_se.lib", { "SMALL_ENUM","LARGE_DATA","MSPX" } },
    { "rts430x_lc_rd_eabi.lib", { "MSPX","RESTRICTED_DATA" } },
    { "rts430x_lc_rd_eabi_eh.lib", { "MSPX","RESTRICTED_DATA","EABI_TDEH","EXCEPTIONS" } },
    { "rts430_eabi_se.lib", { "SMALL_ENUM" } },
    { "rts430x_sc_sd_eabi_eh.lib", { "EXCEPTIONS","SMALL_CODE","MSPX","SMALL_DATA","EABI_TDEH" } },
    { "rts430x_lc_sd_eabi_se.lib", { "MSPX","SMALL_ENUM" } },
    { "rts430x_sc_sd_eabi_se_eh.lib", { "EABI_TDEH","SMALL_DATA","MSPX","SMALL_ENUM","EXCEPTIONS","SMALL_CODE" } },
    { "rts430_eabi_se_eh.lib", { "EXCEPTIONS","SMALL_ENUM","EABI_TDEH" } },
    { "rts430x_sc_sd_eabi_se.lib", { "SMALL_DATA","MSPX","SMALL_CODE","SMALL_ENUM" } },
    { "rts430_eabi.lib", {  } },
